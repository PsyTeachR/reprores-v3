...
Install the `r pkg("faux")` package on your system. This package helps you simulate data.
...
If you don't already have packages like `r pkg("ggplot2")` installed, it will also install these **dependencies** for you. If you don't get an error message at the end, the installation was successful. 
...
You can load the functions in `r pkg("faux")` for your current R session as follows:
