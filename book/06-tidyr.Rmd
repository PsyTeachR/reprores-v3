...
```{r setup-tidyr, results = 'hide', warning = FALSE, message = FALSE, verbatim = "r setup, include = FALSE"}
...
Get data on infant and maternal mortality rates from the `r pkg("reprores")` package. If you don't have the package, you can download them here:
