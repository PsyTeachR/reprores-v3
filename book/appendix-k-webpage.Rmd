...
In this tutorial, you will learn how to create a simple webpage using `r glossary("R Markdown")`, link multiple pages, and style your content using `r glossary("css")`.
